...
public class AnimationGenerator {
	...
	public void applyFadeAnimationOn01(Node node, int duration, double from, double to, int cc,
	...
	public void applyFadeAnimationOn02(Node node, int duration, double from, double to, int cc,
			EventHandler<ActionEvent> eventHandler) {
		FadeTransition fadeTransition = new FadeTransition(Duration.millis(duration), node);
		fadeTransition.setOnFinished(eventHandler);
		fadeTransition.setFromValue(from);
